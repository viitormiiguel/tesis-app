...
# Get the full path
single_face_img_path = os.path.join(path, "064_08.jpg")
...
figs2 = single_face_prediction.plot_detections(faces='aus', muscles=True, emotion_barplot=False, au_barplot=False)

# figs2 = Fex.plot_detections(faces='aus', muscles=True, emotion_barplot=False, au_barplot=False)
